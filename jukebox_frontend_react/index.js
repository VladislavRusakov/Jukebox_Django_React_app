    ...
    return (
        <footer className="footer">
            ...
            <div className="footer--text--container">
                <h6 className="footer--text">By Symbolminded 2024.</h6>
            </div>
        </footer>
    )
}
